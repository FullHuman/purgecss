...
export const ERROR_EXTRACTERS_TYPE =
    "Error Type option extracters: expected an array"

export const ERROR_WHITELIST_TYPE =
    "Error Type option whitelist: expected an array"
...
export const ERROR_REJECTED_TYPE =
    "Error Type option rejected: expected a boolean"
