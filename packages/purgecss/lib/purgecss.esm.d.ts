 ...
 */
export declare function mergeExtractorSelectors(extractorSelectorsA: ExtractorResultDetailed, extractorSelectorsB: ExtractorResultDetailed): ExtractorResultDetailed;
declare class PurgeCSS {
     ...
     * @param selectors selectors used in content files
     */
    walkThroughCSS(root: postcss_$0.Root, selectors: ExtractorResultDetailed): void;
}
